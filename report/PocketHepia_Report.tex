...
%%TODO add diagram with authentication + permission checks before route
\begin{figure}[H]
\begin{center}
...
%% TODO \subsection{Interaction with MongoDB}?
%%TODO really?
...
%%TODO tell that we will talk about main screens only, there are modals then etc, each form has a method in services etc
%%TODO talk about reusing components and modularity
...
\end{center}
\end{figure}
%%TODO start with sidenav that incorporates router outlet with navigation displayed if admin (drawer opening/closing if logged-in)
%%TODO add all the text
%%TODO then do all other screens and show which components are inside
%%TODO screeenshot of components
\subsection{Building the Docker Container}
...
\end{center}
\end{figure}
%%TODO talk about FAB handling, authentication, sync thread, distinct activities for given things
\chapter{Conclusion}
