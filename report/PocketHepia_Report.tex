...
%%TODO add RFID, add JWT, add SDK, add JS, add JSON, add BSON, add API, add PWA, add REST, add EPFL, add RTD, add ASCII, add UTF, add GDPR, add OS
...
\section{Angular 6}
%%TODO \cite{github:angular}
%%TODO \cite{angular:website}
