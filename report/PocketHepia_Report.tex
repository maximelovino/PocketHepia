...
\section{Integration with existing user accounts}
%%TODO why we didn't do LDAP + augmented database => time constraints, network infrastructure, iteration speed because network limitation
