...
%%TODO talk about max document size of 16mb and make example with a person having multiple cars by embedding the car, car ID list in user and user id in car
