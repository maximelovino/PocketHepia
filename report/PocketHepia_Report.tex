...
\end{center}
\end{figure}
%%TODO talk about FAB handling, authentication, sync thread, data management, distinct activities for given things
%%TODO present all main screens with bottom nav and navigation config => user list to user detail for example
\chapter{Conclusion}
