...
\end{center}
\end{figure}
%%TODO link to material sidenav? or schematics generation
First of all, we are talking about the skeleton of the application. We have a Component including a side navigation drawer that can be toggled on and off. The side navigation contains the buttons to access the different pages of the application. The administrative page links will only be displayed if the current user is an administrator. The drawer will also be closed and the button to open it hidden when the user is not logged-in, see section \ref{login_component_implementation}.\\
